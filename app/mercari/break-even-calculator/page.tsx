...
export default function MercariBreakEvenCalculator() {
  ...
  const result = useMemo(() => {
    ...
    const evaluate = (price: number) => {
      const platformFees = price * variableRate + fixed;
      const totalCosts =
        product + shipping + packaging + promotion + returns + platformFees;
    ...
    const safeEval = evaluate(safeBufferPrice);
    const aggressiveEval = evaluate(aggressiveFloorPrice);
      ...
      <div className="mx-auto max-w-5xl">
        <section className="mb-8">
          ...
          <p className="mt-3 max-w-2xl text-slate-600">
            Calculate the minimum Mercari sale price needed to avoid losing
            money after item cost, shipping, packaging, fees, promotions, and
            returns.
          </p>
        </section>
          ...
          <section className="rounded-2xl border bg-white p-5 shadow-sm">
            ...
            <div className="mt-6 rounded-2xl bg-slate-100 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-700">
                ...
                , producing an estimated margin of{" "}
                <span className="font-semibold">
